...
export class GestionStorageService {
  // Creamos un Subject que vigilará el contenido de un array de noticiasStog
  private noticiasSujeto= new Subject<any[]>();
  noticias$ = this.noticiasSujeto.asObservable();
  ...
  async setObject(key: string, value: any) {
    ...
    if (key === 'Noticias') { 
      // Cuando el array cambia el Subject avisa de ello
      this.noticiasSujeto.next(value);
    }
  }
